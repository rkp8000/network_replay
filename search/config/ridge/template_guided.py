...
START = {
    ...
    'P_A_INH_PC': 0.1, 'W_A_INH_PC': 0.009,
    'P_G_PC_INH': 0.1, 'W_G_PC_INH': 0.004,
    'FR_EC': 35,
}
...
FORCE = {
    -1: [
            {
                'RIDGE_H': 0.25, 'RIDGE_W': 4, 'P_INH': 0.1, 'RHO_PC': 1000, 
                'Z_PC': 0.4, 'L_PC': 0.2, 'W_A_PC_PC': 0.0085,
                'P_A_INH_PC': 0.1, 'W_A_INH_PC': 0.009,
                'P_G_PC_INH': 0.1, 'W_G_PC_INH': 0.004,
                'FR_EC': 35,
            },
            {
                'RIDGE_H': 0.25, 'RIDGE_W': 4, 'P_INH': 0.1, 'RHO_PC': 1000, 
                'Z_PC': 0.5, 'L_PC': 0.2, 'W_A_PC_PC': 0.0085,
                'P_A_INH_PC': 0.1, 'W_A_INH_PC': 0.009,
                'P_G_PC_INH': 0.1, 'W_G_PC_INH': 0.004,
                'FR_EC': 35,
            },
            {
                'RIDGE_H': 0.25, 'RIDGE_W': 4, 'P_INH': 0.1, 'RHO_PC': 1000, 
                'Z_PC': 0.6, 'L_PC': 0.2, 'W_A_PC_PC': 0.0085,
                'P_A_INH_PC': 0.1, 'W_A_INH_PC': 0.009,
                'P_G_PC_INH': 0.1, 'W_G_PC_INH': 0.004,
                'FR_EC': 35,
            },
